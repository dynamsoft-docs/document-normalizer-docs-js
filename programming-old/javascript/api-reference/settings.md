...
Gets current runtime settings with a template represented by [`a JSON object`](/document-normalizer/docs/core/parameters/parameter-organization-structure.html?ver=1.0.21).
